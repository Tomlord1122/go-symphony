...
// Change this
var (
	focusedStyle          = lipgloss.NewStyle().Foreground(lipgloss.Color("#7D56F4")).Bold(true)
	titleStyle            = lipgloss.NewStyle().Background(lipgloss.Color("#7D56F4")).Foreground(lipgloss.Color("#2F2F30")).Bold(true).Padding(0, 1, 0)
	selectedItemStyle     = lipgloss.NewStyle().MarginLeft(1).Background(lipgloss.Color("#7D56F4")).Foreground(lipgloss.Color("#2F2F30")).Bold(true)
	selectedItemDescStyle = lipgloss.NewStyle().MarginLeft(1).Foreground(lipgloss.Color("#A9B7BE"))
	descriptionStyle      = lipgloss.NewStyle().Foreground(lipgloss.Color("#909FA6"))
)
